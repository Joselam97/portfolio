    ...
    <React.Fragment>
      <div className="h-[280px] lg:h-[450px] md:h-[400px] sm:-[200px] lg:w-[650px] md:w-[450px] sma:w-[300px] w-[300px] relative m-auto">
        <div className="h-full w-full group cursor-all-scroll z-50 relative">
          ...
          style={{boxShadow: "#01161e -10px 10px 20px 10px"}}
          >
            <svg
        ...
        <div className="absolute top-14 sm:left-12 rounded-lg bg-[#01161e] h-[200px] lg:h-[350px] md:h-[300px] w-full" style={{ boxShadow: "#01161e -10px 10px 20px 10px" }}>
          <div className="relative h-[200px] lg:h-[350px] md:h-[300px] w-[100%]">
            <p className="absolute bottom-3 left-4 text-[#f5f3f4] text-lg font-[300]">{item.name}</p>
          </div>
        </div>
      </div>
    </React.Fragment>
