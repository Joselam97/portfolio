    ...
    <React.Fragment>
      <div className="relative">
        ...
        >
          <div onClick={() => setIsOpen(false)} className="relative w-7 lg:w-10 h-7 lg:h-10 flex justify-center items-center">
            {isOpen ? (
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" class="w-12 h-12 text-black cursor-pointer  ">
      ...
      <header className={"fixed top-0 w-full translate-all duration-500 z-40"}>
        <div className="relative">
          ...
          >
            <nav className="text-white font-recoletaBold text-center text-xl lg:text-xl 2xl:text-2xl uppercase">
            ...
            <section className="mt-14 sm:mt-12 lg:mt-14 text-center relative sm:absolute lg:relative sm:right-0 lg:right-0 h-auto sm:h-full lg:h-auto">
              <h3 className="block sm:hidden lg:block font-bold text-[#ef233c] text-2xl uppercase mb-5">Connect With Me</h3>
              <div className="justify-center items-center flex flex-row sm:flex-col lg:flex-row">
                <a href="https://github.com/Joselam97" className="text-[#adb5bd] hover:text-[#ef233c] transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    stroke-width="0"
                ...
                <a
                  href="https://www.linkedin.com/in/jose-alvarez-003ba818b/"
                  className="text-[#adb5bd] hover:text-[#ef233c] transition-colors duration-300"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/joselam__/"
                  className="text-[#adb5bd] hover:text-[#ef233c] transition-colors duration-300"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <a href="mailto:jlam97@hotmail.es/" className="text-[#adb5bd] hover:text-[#ef233c] transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                  <svg
                    stroke="currentColor"
                    fill="currentColor"
                    stroke-width="0"
