        ...
        <div className="container m-auto">
          ...
          <div style={{ transform: "translate(0px, -250px)" }}>
            ...
            <p className={`max-w-2xl md:pl-[80px] px-5 text-[18px] text-[#47626d] leading-8 mt-5 ${hind.className}`}>
              As a Full Stack Developer, I combine creativity with functionality
              to build intuitive and modern user interfaces using HTML, CSS and JavaScript. On the backend, I
              develop robust and scalable applications with Java, 
              leveraging frameworks like Jakarta EE, JSF and Hibernate, 
              integrated seamlessly with MySQL databases. My
